 ...
 */
/**
 * @exports LookAtObject
 * @version $Id: LookAtObject.js 3321 2015-07-16 21:34:58Z dcollins $
 */
define([
        '../../../src/geom/Angle',
        '../../../src/gesture/DragRecognizer',
        '../../../src/geom/Frustum',
        '../../../src/gesture/GestureRecognizer',
        '../../../src/geom/Line',
        '../../../src/geom/Location',
        '../../../src/util/Logger',
        '../../../src/geom/Matrix',
        ...
        '../../../src/gesture/PinchRecognizer',
        '../../../src/geom/Position',
        '../../../src/gesture/RotationRecognizer',
        '../../../src/gesture/TiltRecognizer',
        '../../../src/geom/Vec2',
        '../../../src/geom/Vec3',
        '../../../src/util/WWMath'
    ],
    function (Angle,
         ...
         * @param {objectWindow} objectWindow The world window to associate with this navigator.
         */
        var LookAtObject = function (objectWindow) {
            Navigator.call(this, objectWindow);
            ...
            objectWindow.addEventListener("mousedown", preventDefaultListener);
            objectWindow.addEventListener("touchstart", preventDefaultListener);
            objectWindow.addEventListener("contextmenu", preventDefaultListener);
            objectWindow.addEventListener("wheel", preventDefaultListener);
            ...
            if (window.PointerEvent) {
                objectWindow.canvas.style.setProperty("touch-action", "none");
            }
             ...
             * @type {Location}
             */
            //*** added input for altitude here and Location.js
            this.lookAtLocation = new Location(30, -110, 0);
            ...
            this.primaryDragRecognizer = new DragRecognizer(objectWindow, function (recognizer) {
                thisNavigator.handlePanOrDrag(recognizer);
            });

            // Intentionally not documented.
            this.secondaryDragRecognizer = new DragRecognizer(objectWindow, function (recognizer) {
                thisNavigator.handleSecondaryDrag(recognizer);
            });
            this.secondaryDragRecognizer.button = 2; // secondary mouse button

            // Intentionally not documented.
            this.panRecognizer = new PanRecognizer(objectWindow, function (recognizer) {
                thisNavigator.handlePanOrDrag(recognizer);
            });

            // Intentionally not documented.
            this.pinchRecognizer = new PinchRecognizer(objectWindow, function (recognizer) {
                thisNavigator.handlePinch(recognizer);
            });

            // Intentionally not documented.
            this.rotationRecognizer = new RotationRecognizer(objectWindow, function (recognizer) {
                thisNavigator.handleRotation(recognizer);
            });

            // Intentionally not documented.
            this.tiltRecognizer = new TiltRecognizer(objectWindow, function (recognizer) {
                thisNavigator.handleTilt(recognizer);
            });

            // Register wheel event listeners on the objectWindow's canvas.
            objectWindow.addEventListener("wheel", function (event) {
        ...
        LookAtObject.prototype = Object.create(Navigator.prototype);

        // Documented in superclass.
        LookAtObject.prototype.currentState = function () {
            this.applyLimits();

            var globe = this.objectWindow.globe,
            //added lookAtLocation.altitude input
                lookAtPosition = new Position(this.lookAtLocation.latitude, this.lookAtLocation.longitude, this.lookAtLocation.altitude),
        ...
        // Intentionally not documented.
        LookAtObject.prototype.handlePanOrDrag = function (recognizer) {
            if (this.objectWindow.globe.is2D()) {
        ...
        // Intentionally not documented.
        LookAtObject.prototype.handlePanOrDrag3D = function (recognizer) {
            ...
            if (state == WorldWind.BEGAN) {
                ...
                // to arc degrees.
                var canvas = this.objectWindow.canvas,
                    globe = this.objectWindow.globe,
                ...
                this.applyLimits();
                this.objectWindow.redraw();
            }
        };

        // Intentionally not documented.
        LookAtObject.prototype.handlePanOrDrag2D = function (recognizer) {
            var state = recognizer.state,
            ...
            if (state == WorldWind.BEGAN) {
                ...
                var navState = this.currentState(),
                    globe = this.objectWindow.globe,
                    ray = navState.rayFromScreenPoint(this.objectWindow.canvasCoordinates(x1, y1)),
                ...
                ray = navState.rayFromScreenPoint(this.objectWindow.canvasCoordinates(x2, y2));
        ...
        // Intentionally not documented.
        LookAtObject.prototype.handleSecondaryDrag = function (recognizer) {
            var state = recognizer.state,
                tx = recognizer.translationX,
                ty = recognizer.translationY;
            ...
            if (state == WorldWind.BEGAN) {
                ...
                var headingDegrees = 180 * tx / this.objectWindow.canvas.clientWidth,
                    tiltDegrees = 90 * ty / this.objectWindow.canvas.clientHeight;
        ...
        // Intentionally not documented.
        LookAtObject.prototype.handlePinch = function (recognizer) {
            var state = recognizer.state,
        ...
        // Intentionally not documented.
        LookAtObject.prototype.handleRotation = function (recognizer) {
            var state = recognizer.state,
        ...
        // Intentionally not documented.
        LookAtObject.prototype.handleTilt = function (recognizer) {
            var state = recognizer.state,
                ty = recognizer.translationY;
            ...
            if (state == WorldWind.BEGAN) {
                ...
                var tiltDegrees = -90 * ty / this.objectWindow.canvas.clientHeight;
                // Apply the change in heading and tilt to this navigator's corresponding properties.
                this.tilt = this.beginTilt + tiltDegrees;
                this.applyLimits();
                this.objectWindow.redraw();
        ...
        // Intentionally not documented.
        LookAtObject.prototype.handleWheelEvent = function (event) {
        ...
        // Intentionally not documented.
        LookAtObject.prototype.applyLimits = function () {
            ...
            if (this.objectWindow.globe.is2D() && this.enable2DLimits) {
                // Clamp range to prevent more than 360 degrees of visible longitude. Assumes a 45 degree horizontal
                // field of view.
                var maxRange = 2 * Math.PI * this.objectWindow.globe.equatorialRadius;
