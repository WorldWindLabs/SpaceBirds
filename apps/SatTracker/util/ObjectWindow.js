 ...
 * @version $Id: ObjectWindow.js 3402 2015-08-14 17:28:09Z tgaskins $
 */
define([
        ...
        '../../../src/globe/Globe',
        '../../../src/globe/Globe2D',
        '../../../src/util/GoToAnimator',
        '../../../src/cache/GpuResourceCache',
        '../../../src/util/Logger',
        '../../../apps/SatTracker/util/LookAtObject',
        '../../../src/navigate/NavigatorState',
        '../../../src/pick/PickedObjectList',
        '../../../src/geom/Rectangle',
        '../../../src/geom/Sector',
        '../../../src/shapes/SurfaceShape',
    ...
    function (ArgumentError,
         ...
         */
        var ObjectWindow = function (canvasName, elevationModel) {
            if (!(window.WebGLRenderingContext)) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "constructor",
             ...
             * This property is read-only. Use [addLayer]{@link ObjectWindow#addLayer} or
             * [insertLayer]{@link ObjectWindow#insertLayer} to add layers to this world window.
             * Use [removeLayer]{@link ObjectWindow#removeLayer} to remove layers from this world window.
             * @type {Layer[]}
             * @readonly
             */
            this.layers = [];
             ...
             */
            this.navigator = new LookAtObject(this);
            ...
            /**
             * Performance statistics for this ObjectWindow.
        ...
        Object.defineProperties(ObjectWindow.prototype, {
            /**
             ...
             * @type {Function[]}
             * @default [ObjectWindow.declutter]{@link ObjectWindow#declutter} with a group ID of 1
             * @readonly
             * @memberof ObjectWindow.prototype
             */
             ...
             * have two arguments: this world window and the redraw stage, e.g., <code style='white-space:nowrap'>redrawCallback(ObjectWindow, stage);</code>.
         ...
         */
        ObjectWindow.prototype.canvasCoordinates = function (x, y) {
         ...
         */
        ObjectWindow.prototype.addEventListener = function (type, listener) {
            if (!type) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "addEventListener", "missingType"));
            }

            if (!listener) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "addEventListener", "missingListener"));
            }

            var thisObjectWindow = this;
            var entry = this.eventListeners[type];
            if (!entry) {
                entry = {
                    listeners: [],
                    callback: function (event) { // calls listeners in reverse registration order
                        event.objectWindow = thisObjectWindow;
         ...
         * @throws {ArgumentError} If any argument is null or undefined.
         */
        ObjectWindow.prototype.removeEventListener = function (type, listener) {
            if (!type) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "removeEventListener", "missingType"));
            }

            if (!listener) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "removeEventListener", "missingListener"));
            }
         ...
         */
        ObjectWindow.prototype.redraw = function () {
         ...
         */
        ObjectWindow.prototype.pick = function (pickPoint) {
            if (!pickPoint) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "pick", "missingPoint"));
            }
         ...
         * @throws {ArgumentError} If the specified pick point is null or undefined.
         */
        ObjectWindow.prototype.pickTerrain = function (pickPoint) {
            if (!pickPoint) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "pickTerrain", "missingPoint"));
            }
         ...
         */
        ObjectWindow.prototype.pickShapesInRegion = function (rectangle) {
            if (!rectangle) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "pickShapesInRegion", "missingRectangle"));
            }
        ...
        ObjectWindow.prototype.createContext = function (canvas) {
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.handleContextLost = function (event) {
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.handleContextRestored = function (event) {
            Logger.log(Logger.LEVEL_INFO, "WebGL context event: " + event.statusMessage);
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.handleRedrawEvent = function (event) {
            this.redraw(); // redraw in the next animation frame
        };

        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.animationFrameLoop = function () {
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.redrawIfNeeded = function () {
            ...
            try {
                ...
                Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "redrawIfNeeded",
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.resize = function () {
        ...
        // Internal. Intentionally not documented.
        ObjectWindow.prototype.resetDrawContext = function () {
            this.globe.offset = 0;
        ...
        /*
         ...
         ObjectWindow.prototype.logAndValidate = function logAndValidate(functionName, args) {
         logGLCall(functionName, args);
         validateNoneOfTheArgsAreUndefined (functionName, args);
         };

         ObjectWindow.prototype.throwOnGLError = function throwOnGLError(err, funcName, args) {
         throw WebGLDebugUtils.glEnumToString(err) + " was caused by call to: " + funcName;
         };
         */

        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.drawFrame = function () {
            try {
        ...
        ObjectWindow.prototype.doNormalRepaint = function () {
            this.createTerrain();
            this.clearFrame();
        ...
        ObjectWindow.prototype.do2DContiguousRepaint = function () {
        ...
        ObjectWindow.prototype.resolvePick = function () {
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.beginFrame = function () {
            var gl = this.drawContext.currentGlContext;
            gl.enable(gl.BLEND);
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.endFrame = function () {
            var gl = this.drawContext.currentGlContext;
            gl.disable(gl.BLEND);
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.clearFrame = function () {
            var dc = this.drawContext,
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.doDraw = function () {
        ...
        ObjectWindow.prototype.redrawSurface = function () {
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.doPick = function () {
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.createTerrain = function () {
            var dc = this.drawContext;
        ...
        ObjectWindow.prototype.makeCurrent = function (offset) {
            var dc = this.drawContext;
        ...
        ObjectWindow.prototype.createTerrain2DContiguous = function () {
            var dc = this.drawContext;
        ...
        ObjectWindow.prototype.draw2DContiguous = function () {
            var drawing = "";
        ...
        ObjectWindow.prototype.pick2DContiguous = function () {
            if (this.terrainCenter) {
                this.makeCurrent(0);
                this.deferOrderedRendering = this.terrainLeft || this.terrainRight;
                this.doPick();
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.drawLayers = function (accumulateOrderedRenderables) {
            // Draw all the layers attached to this ObjectWindow.
         ...
         */
        ObjectWindow.prototype.addLayer = function (layer) {
         ...
         * window's layer list.
         */
        ObjectWindow.prototype.removeLayer = function (layer) {
            if (!layer)
                return;
         ...
         */
        ObjectWindow.prototype.insertLayer = function (index, layer) {
            if (layer) {
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.drawSurfaceRenderables = function () {
            var dc = this.drawContext,
                sr;
            ...
            while (sr = dc.popSurfaceRenderable()) {
                try {
                    ...
                    Logger.logMessage(Logger.LEVEL_WARNING, "ObjectWindow", "drawSurfaceRenderables",
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.drawOrderedRenderables = function () {
            var beginTime = Date.now(),
                dc = this.drawContext,
                or;
            ...
            while (or = dc.popOrderedRenderable()) {
                try {
                    ...
                    Logger.logMessage(Logger.LEVEL_WARNING, "ObjectWindow", "drawOrderedRenderables",
        ...
        ObjectWindow.prototype.drawScreenRenderables = function () {
            var dc = this.drawContext,
                or;
        ...
        // Internal function. Intentionally not documented.
        ObjectWindow.prototype.resolveTopPick = function () {
        ...
        // Internal. Intentionally not documented.
        ObjectWindow.prototype.resolveTerrainPick = function () {
            var pickedObjects = this.drawContext.objectsAtPickPoint,
                po;
        ...
        // Internal. Intentionally not documented.
        ObjectWindow.prototype.resolveRegionPick = function () {
            if (this.drawContext.objectsAtPickPoint.objects.length == 0) {
        ...
        // Internal. Intentionally not documented.
        ObjectWindow.prototype.callRedrawCallbacks = function (stage) {
         ...
         */
        ObjectWindow.prototype.goTo = function (position, completionCallback) {
         ...
         * [orderedRenderingFilters]{@link ObjectWindow#orderedRenderingFilters} property.
         * <p>
         ...
         */
        ObjectWindow.prototype.declutter = function (dc, groupId) {
            if (!groupId) {
                throw new ArgumentError(
                    Logger.logMessage(Logger.LEVEL_SEVERE, "ObjectWindow", "declutter",
