...
define([
    ...
    function (ArgumentError,
         ...
         */
        var Navigator = function (objectWindow) {
            if (!objectWindow) {
        ...
        Navigator.prototype.currentStateForModelview = function (modelviewMatrix) {
            ...
            var globe = this.objectWindow.globe,
                ...
                viewport = this.objectWindow.viewport,
                viewDepthBits = this.objectWindow.depthBits,
                distanceToSurface,
                maxNearDistance,
            ...
            //Arbitrary magic number to set the far clip plane farther in space
            this.farDistance += 60000000;
            if (this.farDistance < 1e3)
                this.farDistance = 1e3;
            //Arbitrary magic variable (and number) to avoid the previous magic number to affect the near clip plane
